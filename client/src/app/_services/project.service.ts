...
export class ProjectService {
  projects: Project[] = [    
    ...
    {id: 4, name: "Spaceship For Newbies", pictures: ["../../assets/spaceship-for-newbies/image1.jpg","../../assets/spaceship-for-newbies/image2.jpg","../../assets/spaceship-for-newbies/image3.jpg"], projectLink: "https://store.steampowered.com/app/1568130/Spaceship_for_Newbies/", summary: "Jogo digital para windows e Android Desenvolvido na Unity", description: "Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.", tags: [Tag.UNITY, Tag.CSHARP]}
  ]
